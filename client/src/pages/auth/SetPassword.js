...
const SetPassword = () => {
    ...
    useEffect(() => {
        if (status && status === 200) {
            toast.success('New Password Crate Successfully...', { theme: "colored" });
        }
            ...
            <div className="auth-inner row m-0">
                ...
                <div className="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                    <div className="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                        ...
                        <h1 className="brand-text text-primary text-center mb-3">Create New Password</h1>
                        <p className="card-text mb-2">Create new password for you WiteX Digital Panel...</p>
                        <form onSubmit={ResetPasswordFunction} method="POST">
                            ...
                            <button className="btn btn-primary btn-block" disabled={loading}> {loading ? 'Creating...' : 'Create'}</button>
                        </form>

                        <div class="text-center">
                            <Link to="/login" class="d-flex align-items-center justify-content-center mt-1">
                                <ChevronLeft className='input-feather-icon-size' />&nbsp;&nbsp;Back to Login
                            </Link>
                        </div>
