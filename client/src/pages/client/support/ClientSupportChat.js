...
import { CreateSupportChatAction, GetSingleSupportTicketAction } from '../../../redux/actions/Client/SupportAction';
import { SUPPORT_CHAT_RESET } from '../../../redux/constants/Client/SupportConstant';
const ClientSupportChat = () => {
    ...
    return (
        <div className="content-wrapper">
            <MetaData title="Client - Support Tickets Chat" />
