...
import { ClientInitialPermissions } from '../Permissions';
import { CreateTeamAction } from '../../../redux/actions/Client/TeamAction';
import { CLEAR_ERRORS, CREATE_TEAM_RESET } from '../../../redux/constants/Client/TeamConstant';


const ClientTeamCreate = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();

    const { loading, isCreated, status, message } = useSelector((state) => state.teams);
    ...
    const CreateTeamFunction = async (event) => {
    ...
    return (
        <div className="content-wrapper">
            <MetaData title="Client - Create Team" />
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-header border-bottom ">
                                <h4 className="card-title">Create Team </h4>
                            </div>

                            {
                                loading ? <LoadingTable /> : (
                                    <form method="post" onSubmit={CreateTeamFunction} className='p-2'>
                                        <div className='row'>
                                            <div className='col'>
