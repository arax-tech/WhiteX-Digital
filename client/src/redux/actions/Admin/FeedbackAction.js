...
export const GetFeedbacksAction = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${BaseURL}/api/admin/feedback`, {
            headers: {
...
export const GetSingleFeedbackAction = (id) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.get(`${BaseURL}/api/admin/feedback/single/${id}`, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
            }
...
export const CreateFeedbackAction = (form) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.post(`${BaseURL}/api/admin/feedback/store`, form, {
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`
            }
...
export const UpdateFeedbackAction = (id, form) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.post(`${BaseURL}/api/admin/feedback/update/${id}`, form, {
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`
            }
...
export const DeleteFeedbackAction = (id) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.get(`${BaseURL}/api/admin/feedback/delete/${id}`, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
            }
