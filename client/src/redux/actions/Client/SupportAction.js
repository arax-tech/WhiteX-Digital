...
export const GetSupportTicketsAction = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${BaseURL}/api/client/support`, {
            headers: {
...
export const CreateSupportChatAction = (id, content) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.post(`${BaseURL}/api/client/support/chat/store/${id}`, { content },
            {
                headers: {
                    "Authorization": `Bearer ${token}`,
                    'Content-Type': 'application/json',
...
export const GetSingleSupportTicketAction = (id) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.get(`${BaseURL}/api/client/support/single/${id}`, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
            }
...
export const CreateSupportTicketAction = (form) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.post(`${BaseURL}/api/client/support/store`, form, {
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`
            }
...
export const UpdateSupportTicketAction = (id, form) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.post(`${BaseURL}/api/client/support/update/${id}`, form, {
            headers: {
                'Content-Type': 'application/json',
                "Authorization": `Bearer ${token}`
            }
...
export const DeleteSupportTicketAction = (id) => async (dispatch) => {
    try {
        ...
        const token = localStorage.getItem('token');
        const { data } = await axios.get(`${BaseURL}/api/client/support/delete/${id}`, {
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`
            }
