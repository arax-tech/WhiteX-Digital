  ...
  <VNavigationDrawer temporary :model-value="!!props.email" location="right" :scrim="false" floating class="email-view">
    <template v-if="props.email">
      ...
      <div class="email-view-header d-flex align-center px-5 py-3">
        ...
        <div class="d-flex align-center flex-wrap flex-grow-1 overflow-hidden gap-3">
          ...
          <div class="d-flex flex-wrap gap-1">
            <VChip v-for="label in props.email.labels" :key="label" :color="resolveLabelColor(label)" density="default"
      ...
      <div class="email-view-action-bar d-flex align-center text-medium-emphasis px-5">
        <!-- Trash -->
        <IconBtn v-show="!props.email.isDeleted" @click="$emit('trash'); $emit('close')">
          ...
          <VMenu activator="parent">
            <VList density="compact">
              <template v-for="moveTo in emailMoveToFolderActions" :key="moveTo.title">
                <VListItem :class="shallShowMoveToActionFor(moveTo.action) ? 'd-flex' : 'd-none'" class="align-center"
                  href="#" @click="handleMoveMailsTo(moveTo.action)">
                  <template #prepend>
          ...
          <div class="d-flex align-start align-sm-center px-6 py-3">
            ...
            <div class="d-flex flex-wrap flex-grow-1 overflow-hidden">
              <div class="text-truncate">
                <span class="d-block text-high-emphasis font-weight-medium text-truncate">{{ props.email.from.name
                }}</span>
              ...
              <div class="d-flex align-center">
                ...
                <!-- Star/Unstar -->
                <IconBtn :color="props.email.isStarred ? 'warning' : 'default'"
            ...
            <MoreBtn class="align-self-sm-center" density="comfortable" color="undefined" />
          </div>
          ...
          <template v-if="props.email.attachments.length">
            ...
            <VCardText class="d-flex flex-column gap-y-4 pt-4">
              ...
              <div v-for="attachment in props.email.attachments" :key="attachment.fileName" class="d-flex align-center">
                <VImg :src="attachment.thumbnail" :alt="attachment.fileName" aspect-ratio="1" max-height="24"
                  max-width="24" class="me-2" />
