  ...
  <VCard>
    <VCardItem>
      ...
      <p class="text-sm mt-2 mb-0">
        We need permission from your browser to show notifications. <span class="font-weight-bold">Request
          Permission</span>
      </p>
    </VCardItem>
    ...
    <VCardText>
      <VForm @submit.prevent="() => { }">
        ...
        <VRow>
          <VCol cols="12" sm="6">
            <AppSelect v-model="selectedNotification" mandatory :items="['Only when I\'m online', 'Anytime']" />
          </VCol>
        </VRow>
